...
public class Blaze implements Ability, OnHpThreshold {
    ...
    public String getDescription() {
        return "When this Pokemon's HP is below 1/3, its Fire-type moves deal 1.5x damage.";
    }
    ...
    public double onHpThreshold(Pokemon owner, Move move) {
        if (move.getType().getType() == TypeList.Fire) {
            return 1.5;
        }
        return 1.0;
    }
